...
!
! The coordinate system is the one dfined by Okada (1992,
...
!   y = horizontal, normal to strike, pointing in the direction opposite to the
!   fault dip direction
...
! In compute_kernel, sigma is the normal stress change in the direction n_f,
! thus:
...
! where slip is defined as the displacement of the hanging wall relative to the
! footwall.
...
!   the sign convention of QDYN's tau and sigma is opposite to that of
!   compute_kernel's tau and sigma.
!
